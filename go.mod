module github.com/debyltech/go-snipcart-api
...
require (
	...
	github.com/debyltech/go-snipcart v0.2.6
...
replace github.com/debyltech/go-snipcart-api/config => ./config

replace github.com/debyltech/go-snipcart-api/debug => ./debug
